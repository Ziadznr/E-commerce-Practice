  ...
  return (
    <div className="section">
      <div className="container">
        <div className="row">
          <h1 className="headline-6 text-center my-2 p-0">Top Brands</h1>
          <span className="bodySmall mb-5 text-center">
            Explore a World of Across Our Most Popular <br />
            Shopping Categories
          </span>
          {Array.from({ length: 12 }).map((_, index) => (
            <div key={index} className="col-6 col-lg-1 text-center col-md-2 p-2">
